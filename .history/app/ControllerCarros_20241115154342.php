...
//Aqui vai levar o métodos do api
   ...
   public function getAll() {
    try {
        $query = "SELECT * FROM goncaloCarros";
...
public function getById($id) {
    try {
        $query = "SELECT * FROM goncaloCarros WHERE id = :id";
        $stmt = $this->conn->prepare($query);
...
public function create() {
    try {
        $query = "INSERT INTO goncaloCarros (marca, detalhes, foto) VALUES (:marca, :detalhes, :foto)";
        $stmt = $this->conn->prepare($query);
...
public function update() {
    try {
        ...
        $query = "UPDATE goncaloCarros SET marca = :marca, detalhes = :detalhes, foto = :foto WHERE id = :id";
        $stmt = $this->conn->prepare($query);
